				...
				<dl class="interestinfo">				
					...
					<xsl:for-each select="interestinfo/item">					
						...
						<xsl:choose>
							...
							<xsl:when test="intercode='00100003' or intercode='00030003' or intercode='00100004' or intercode='00030012' or intercode='00100005' or intercode='00100006' or intercode='00100008'">								
	...
	<xsl:template match="timetable">		
	    ...
	    <div id="horari">
			<p><span class="bold"><xsl:value-of select="horari/@label" /></span></p>			
				...
				<xsl:for-each select="horari">
				<p>
                    <xsl:value-of select="periode" disable-output-escaping="yes" /><xsl:text> </xsl:text>
                    <xsl:value-of select="dies"	disable-output-escaping="yes" /><xsl:text> </xsl:text>
                    <xsl:value-of select="hores" disable-output-escaping="yes" /><xsl:text> </xsl:text>
                    <xsl:value-of select="preu" disable-output-escaping="yes" /><xsl:text> </xsl:text>
                    <xsl:value-of select="observacions" disable-output-escaping="yes" /><xsl:text> </xsl:text>
                </p>			    
