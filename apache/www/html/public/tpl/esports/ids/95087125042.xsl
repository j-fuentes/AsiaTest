...
<script type="text/javascript">
  bcn.statistics();
		...
		<link rel="stylesheet" type="text/css" media="screen" href="http://www.bcn.cat/css_accessible/components/barra.css" />	
		...
		<div id="col-detall-0" >	
			   ...
			   <dl>
				...
				<dl class="interestinfo">				
				 ...
				 <p class="comments">PODEMOS AÑADIR TEXTO O QUITAR</p>	
