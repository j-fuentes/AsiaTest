		...
		var	ids = {},
			...
			tpl = {
				wrapper: '<div class="datepicker">'+
								...
								'<li class="datepickerGoPrev"><a href="#"><span><img src="/tpl/common/img/datepicker/datepicker-esq.png" alt=""/></span></a></li>'+
								'<li id="dt-Month1" class="datepickerMonth"><span></span></li>'+
								'<li class="datepickerGoNext"><a href="#"><span><img src="/tpl/common/img/datepicker/datepicker-dreta.png" alt=""/></span></a></li>'+
			...
			locale_es: {		days: ["Domingo", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
			...
			locale_ca:	{	days: ["Diumenge", "Dilluns", "Dimarts", "Dimecres", "Dijous", "Divendres", "Dissabte", "Diumenge"],
			...
			click = function(ev) {			
				...
				if (el.is('a') || el.is('img')) {
					...
					if (parentEl.is('span')) {					    
						...
						} else { if (parentEl.parent().parent().is('li')) {//abans thead
						    
							//switch (tblEl.get(0).className) {
							switch ('datepickerViewDays') {
								case 'datepickerViewDays':
									options.current.addMonths(parentEl.parent().parent().hasClass('datepickerGoPrev') ? -1 : 1);
									break;
								/*case 'datepickerViewMonths':
