  ...
  (function() {
			   ...
			   <dl>
				...
				<dl class="interestinfo">				
					...
					<xsl:for-each select="interestinfo/item">
                    	<xsl:choose>
                      		<xsl:when test="intercode='00030014'">
                      	 	 <dt><xsl:text> Web venda d'entrades:</xsl:text></dt>
                          </xsl:when>
                          <xsl:when test="intercode='00030018'">
                      	 	 <dt><xsl:text> Twitter:</xsl:text></dt>
                          </xsl:when>
                          <xsl:otherwise>
   ...
   <!-- TEMPLATE resultats -->
	...
	<div>	
        ...
        <p>Organitzat per <a href="associacio-omnium-cultural_92086004040.html"><span class="notranslate">Associació Òmnium Cultural</span></a>. </p><p>Es venen les entrades a <a href="atrapalocom_325114254.html"><span class="notranslate">Atrapalo.com</span></a> i a <a href="http://www.telentrada.com">Telentrada - CatalunyaCaixa</a>. Venda d'entrades temporalment aturada</p><p>Se celebra a <a href="camp-nou-futbol-club-barcelona_95152103742.html"><span class="notranslate">Camp Nou - Futbol Club Barcelona</span></a>. </p>
	</div>	
	</xsl:if>
	</xsl:template>
