...
function loadmapdetall(gmapx, gmapy, strElement) {
	...
	var houseMarker = new google.maps.MarkerImage("http://guia.bcn.cat/tpl/guiabcn/images/eq.png",markerSize);
	...
	var houseMarkerShadow = new google.maps.MarkerImage("http://guia.bcn.cat/tpl/guiabcn/images/sombra-map.png",markerShadowSize,markerShadowPoint,markerShadowAnchor);
