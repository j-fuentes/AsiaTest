...
function bcn_form_system_theme_settings_alter(&$form, $form_state) {

     /* Funcio per escollir barra*/
 $form['color_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('Configuració del color'),
    '#collapsible' => FALSE,
    '#collapsed' => FALSE
  );
 
 $form['color_settings']['color'] = array(
  '#type' => 'select',
  '#title' => t('Tria el color del site'),
  ...
  '#description' => t('Color dels enllaços i backgrounds genèrics'),
);
  ...
  $form['options_settings']['bcn_breadcrumb'] = array(
    '#type'          => 'fieldset',
    '#title'         => t('Breadcrumb settings'),
    '#attributes'    => array('id' => 'basic-breadcrumb'),
  );
  $form['options_settings']['bcn_breadcrumb']['bcn_breadcrumb'] = array(
    '#type'          => 'select',
    '#title'         => t('Display breadcrumb'),
    '#default_value' => theme_get_setting('bcn_breadcrumb'),
    '#options'       => array(
                          'yes'   => t('Yes'),
  ...
  $form['options_settings']['bcn_breadcrumb']['bcn_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Breadcrumb separator'),
    '#description'   => t('Text only. Don’t forget to include spaces.'),
    '#default_value' => theme_get_setting('bcn_breadcrumb_separator'),
    '#size'          => 5,
    '#maxlength'     => 10,
    '#prefix'        => '<div id="div-basic-breadcrumb-collapse">', // jquery hook to show/hide optional widgets
  );
  $form['options_settings']['bcn_breadcrumb']['bcn_breadcrumb_home'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Show home page link in breadcrumb'),
    '#default_value' => theme_get_setting('bcn_breadcrumb_home'),
  );
  $form['options_settings']['bcn_breadcrumb']['bcn_breadcrumb_trailing'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append a separator to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('bcn_breadcrumb_trailing'),
    '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
  );
  $form['options_settings']['bcn_breadcrumb']['bcn_breadcrumb_title'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append the content title to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('bcn_breadcrumb_title'),
